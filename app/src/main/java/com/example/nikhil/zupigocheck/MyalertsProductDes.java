 ...
 */
public class MyalertsProductDes extends Activity implements View.OnClickListener {
    ...
    private Button buybutton,trackbutton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // trackbutton.setVisibility(View.INVISIBLE);
        ...
        arrlistmonth = new ArrayList<String>();
        Intent i = getIntent();
        ...
        if (PID.startsWith("AZ")) {
            ...
            textlistedprice.setText( listedprice);
        ...
        Log.d(imageUrl + data.toString(), "url of image");
        imageLoader.get(String.valueOf(data), ImageLoader.getImageListener(imageView, R.mipmap.ic_launcher,
                android.R.drawable.ic_dialog_alert));
        imageView.setImageUrl(String.valueOf(data), imageLoader);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.REGISTER_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(MyalertsProductDes.this, response, Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(MyalertsProductDes.this, error.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
    ...
    private void getGraphData() {
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(MyalertsProductDes.this, String.valueOf(error), Toast.LENGTH_LONG).show();
...
//setting the margin size for the graph in the order top, left, bottom, right
        ...
        multiRenderer.setMargins(new int[]{30, 110, 60, 30});
...
//drawing line chart
        ...
        mChart = ChartFactory.getLineChartView(MyalertsProductDes.this, dataset, multiRenderer);
...
// sorting list inot desc order in order to diaply last 4 values in table layout
        ...
        Toast.makeText(MyalertsProductDes.this, arrlist.size() + "****" + arrlistmonth.size(), Toast.LENGTH_LONG).show();
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.imageView2:
                startActivity(new Intent(context, MyAlerts.class));

                break;
            case R.id.button:
                Intent it = new Intent(MyalertsProductDes.this, LoadWebView.class);
                ...
                try {
                    ...
                    if (FKPid && FKinstalled) {
                        ...
                        LaunchIntent.setData(Uri.parse(buyNow));
                        startActivity(LaunchIntent);
                        Toast.makeText(context, "Launching Flipkart", Toast.LENGTH_LONG).show();
                    } else if (AZPid && AZinstalled) {
                        Intent LaunchIntent = getPackageManager()
                                .getLaunchIntentForPackage("in.amazon.mShop.android.android.shopping");
                        LaunchIntent.setData(Uri.parse(buyNow));
                        startActivity(LaunchIntent);
                        Toast.makeText(context, "Launching Amazon", Toast.LENGTH_LONG).show();
